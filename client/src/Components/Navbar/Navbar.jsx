              ...
              <li>
                ...
                {showMenu && (
                  <div className="dropdown-menu flex flex-col justify-center items-center fixed top-20 right-40  text-xl bg-slate-200 w-48 p-4 rounded-2xl shadow shadow-slate-700">
                    <Link
                      to="/profile"
                      className="w-full h-full p-3 hover:rounded-t-xl hover:bg-slate-500 flex flex-col justify-center items-center hover:text-slate-200"
                    >
                      Profile
                    </Link>
                    ...
                    <button
                      className="logout-btn p-3 w-full h-full hover:rounded-b-xl hover:bg-slate-500 hover:text-slate-200
                    "
                    >
                      Logout
                    </button>
