...
const Blog = () => {
  ...
  return (
    <div className="screen-container blog flex flex-col justify-center items-center md:flex-row lg:justify-around lg:gap-2 w-screen ">
      <Navbar screen="blog" />

      <div className="left-div w-full px-6 md:w-2/3 rounded-xl flex flex-col justify-center items-left">
        <div className="relative w-full  md:10/12  my-2  flex flex-col justify-center items-center ">
          <button
            onClick={scrollLeft}
          ...
          >
            {[
              ...
              <div
                key={title}
                className="bg-gray-500 h-6 md:h-10 text-sm md:text-xl w-auto radius-xl"
              >
                {title}
              </div>
            ))}
        ...
        <div className="blog-container-container flex flex-col my-2  h-80 overflow-y-scroll overflow-x-hidden ">
          <div className="blog-container">
            <div className="flex  justify-start gap-2  items-center">
              <img src={userProfile} className="w-4 h-4 rounded-full" alt="" />
